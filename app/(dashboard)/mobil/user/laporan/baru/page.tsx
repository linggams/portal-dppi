...
export default function MobilUserLaporanBaruPage() {
  return (
    ...
    >
      <MobilUserLaporanBaruForm />
    </Suspense>
  )
}

function MobilUserLaporanBaruForm() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/mobil/user/laporan/${created.idLaporan}`)
    } catch (error) {
    ...
    <DashboardLayout title="Input Laporan">
      <PageActions>
        <Button variant="outline" asChild>
          <Link href="/mobil/user/laporan">Kembali ke daftar</Link>
        </Button>
